...
export const Races: Race[] = [
    ...
    { key: 'catfolk',          name: 'Catfolk',                                 str:  0, dex:  2, con:  0, int:  0, wis: -2, cha:  2, custom: false, addSingleBonus: false, note: '' },
    { key: 'changeling',       name: 'Changeling',                              str:  0, dex:  0, con: -2, int:  0, wis:  2, cha:  2, custom: false, addSingleBonus: false, note: '' },
    { key: 'dhampir',          name: 'Dhampir',                                 str:  0, dex:  2, con: -2, int:  0, wis:  0, cha:  2, custom: false, addSingleBonus: false, note: '' },
    { key: 'dhampirjiangshi',  name: 'Dhampir (Jinag-Shi-Born) (Ru-Shi)',       str:  0, dex: -2, con:  0, int:  2, wis:  0, cha:  0, custom: false, addSingleBonus: false, note: '' },
    { key: 'dhampirmoroi',     name: 'Dhampir (Moroi-born) (Svetocher)',        str:  2, dex:  0, con: -2, int:  0, wis:  0, cha:  2, custom: false, addSingleBonus: false, note: '' },
    { key: 'dhampirvetala',    name: 'Dhampir (Vetala-born) (Ajibachana)',      str:  0, dex:  2, con:  0, int:  2, wis: -2, cha:  0, custom: false, addSingleBonus: false, note: '' },
    { key: 'dhampirnosferatu', name: 'Dhampir (Nosferatu-born) (Ancient-born)', str:  2, dex:  0, con:  0, int:  0, wis:  2, cha:  0, custom: false, addSingleBonus: false, note: '' },
    { key: 'drow',             name: 'Drow',                                    str:  0, dex:  2, con: -2, int:  0, wis:  0, cha:  2, custom: false, addSingleBonus: false, note: '' },
    { key: 'duergar',          name: 'Duergar',                                 str:  0, dex:  0, con:  2, int:  0, wis:  2, cha: -4, custom: false, addSingleBonus: false, note: '' },
    { key: 'fetchling',        name: 'Fetchling',                               str:  0, dex:  2, con:  0, int:  0, wis: -2, cha:  2, custom: false, addSingleBonus: false, note: '' },
    { key: 'goblin',           name: 'Goblin',                                  str: -2, dex:  4, con:  0, int:  0, wis:  0, cha: -2, custom: false, addSingleBonus: false, note: '' },
    { key: 'hobgoblin',        name: 'Hobgoblin',                               str:  0, dex:  2, con:  2, int:  0, wis:  0, cha:  0, custom: false, addSingleBonus: false, note: '' },
    ...
    { key: 'orc',              name: 'Orc',                                     str:  4, dex:  0, con:  0, int: -2, wis: -2, cha: -2, custom: false, addSingleBonus: false, note: '' },
    ...
    { key: 'ratfolk',          name: 'Ratfolk',                                 str: -2, dex:  2, con:  0, int:  2, wis:  0, cha:  0, custom: false, addSingleBonus: false, note: '' },
